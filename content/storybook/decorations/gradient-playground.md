...
<nu-flow gap="2x" size="lg">
  ...
  <nu-grid columns="auto 1fr" gap="1x" items="center start">
    <nu-el>From</nu-el>
    <nu-slider fill="@from" min="0" max="359" value="280" control="props[from=hue(@ special)]"></nu-slider>
    <nu-el>To</nu-el>
    <nu-slider fill="@to" min="0" max="359" value="320" control="props[to=hue(@ special)]"></nu-slider>
    <nu-el>Angle</nu-el>
    <nu-slider image min="0" max="359" value="345" control="props[angle=@deg]"></nu-slider>
  </nu-grid>
